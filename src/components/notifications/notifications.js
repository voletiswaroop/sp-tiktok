    ...
    return (
      <section className="notifications-wrapper">
        <div className="header">
          <p></p>
          <p className="user-name">Inbox<i class="fas fa-caret-down"></i></p>
        ...
        <div className="notifications-container">
          ...
          <div className="notification-details">
            <i className="fas fa-user-circle"></i>
            <div className="notification-group">
              <p className="user-name">Gutpa</p>
              <p className="user-notification">Started following you <span> 3d</span></p>
            </div>
            <p className="empty-cell"></p><p className="follow-btn">Follow</p>
          </div>
          ...
          <div className="notification-details">
            <i className="fas fa-user-circle"></i>
            <div className="notification-group">
              <p className="user-name">Voleti</p>
